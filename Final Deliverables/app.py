...
def index():
    if request.method == 'POST':
       ...
       # NOTE: you must manually set API_KEY below using information retrieved from your IBM Cloud account.
        API_KEY = "RvmmRgqEOrBoO2NiKsHfkKZsE5jWEAqVn4Qzc7tWXMYA"
 ...
 API_KEY, "grant_type": 'urn:ibm:params:oauth:grant-type:apikey'})
        ...
        response_scoring = requests.post('https://eu-gb.ml.cloud.ibm.com/ml/v4/deployments/caa14383-0820-4191-a2c0-44e93efe9468/predictions?version=2022-11-20', json=payload_scoring,
